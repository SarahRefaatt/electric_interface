                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 h-full flex flex-col justify-between">
                                            <div>
                                                ...
                                                <div className="text-lg text-gray-300 mb-6 font-medium border-l-4 border-cyan-500 pl-4 py-2">
                                                    {project.description}
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-3">
                                                {project.tags.map((tag, idx) => (
                                                    <span
                                                        key={idx}
                                                        className="text-sm bg-gradient-to-r from-gray-800 to-gray-900 text-cyan-200 px-4 py-2 rounded-lg font-medium border border-gray-700/50"
                                                        style={{
                                                            transform: "translateZ(20px)",
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="relative h-[500px] flex items-center justify-center">
                                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-teal-500/5 rounded-full blur-3xl"></div>
